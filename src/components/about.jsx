  ...
  <section className="about-section">
    ...
    <div className="about-right">
      ...
      <p className="p">
        ...
        of development and security. With hands-on experience in Python, C, and JavaScript, I aim to grow as a 
        versatile professional capable of contributing to both software development and secure system design.
      </p>
    </div>
  </section>
);
